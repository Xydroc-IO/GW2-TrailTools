...
Raidcore **Nexus** ImGui DLL. Current shipping version: **1.0.0.1**. Normative allow/deny: [`COMPLIANCE.md`](COMPLIANCE.md).
...
2. **Domain folders** only: `app/`, `ui/`, `pathing/`, `packedit/`, `trailtools/` (+ Nexus `entry*`).
...
| Pad chrome / QuickAccess / WorldClick | `src/ui/` |
