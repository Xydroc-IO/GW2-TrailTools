...
- Pack / Trails / Markers / Live / Keybinds authoring hub
- OverlayData project + up to four TrailsN / MarkersN editors
...
Shipping revision is **1.0.0** (`src/app/AddonVersion.h` / CMake `VERSION 1.0.0`). See [`RELEASE_NOTES.md`](RELEASE_NOTES.md) and [`CHANGELOG.md`](CHANGELOG.md).
