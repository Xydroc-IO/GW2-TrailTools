...
namespace TrailToolsWorldPick
{
	...
	bool CameraRayAt(float mx, float my, WorldGpsMath::Vec3& cam, WorldGpsMath::Vec3& dir);
	bool RayPlaneY(float planeY, float& outX, float& outY, float& outZ);
	bool RayPlaneYAt(float planeY, float mx, float my, float& outX, float& outY, float& outZ);
